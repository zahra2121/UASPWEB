...
<body>
    ...
    <div class="databuku2">
        ...
        <br><div class="content">
            <label class="modal-open modal-label" for="modal-open"><p>Pinjam Buku</p></label>
            ...
            <div class="content">
                ...
                <div>
                    <form method="post">
                        ...
                        <button type="submit" class="tombol" name="addpinjam">Submit</button>
                    </form>
                </div>
            </div>
            </div>  
        </div>
        <br><h2 class="judul">🐾Peminjaman Buku</h2><br><br>
        <table class="customers">
            ...
            <?php
                $ambil = mysqli_query($conn, "select * from pinjambuku m, stockbuku s where s.kodebuku = m.kodebuku");
                $a = 1;
